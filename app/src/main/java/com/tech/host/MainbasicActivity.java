...
public class MainbasicActivity extends  AppCompatActivity  { 
	...
	private void initializeLogic() {
		...
		webview1.setDownloadListener(new DownloadListener() {
				public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
						ProgressDialog downloading = ProgressDialog.show(MainbasicActivity.this, "Please wait", "Downloading " + URLUtil.guessFileName(url, contentDisposition, mimetype) + "...", true);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(0, 1, 1, "Switch To Premium").setIcon(R.drawable.change).setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		switch (item.getItemId()) {
			...
			break;
			case 1 :
			dialog2.setMessage("Are you sure you want to switch to the premium panel ?");
